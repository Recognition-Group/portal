...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  let itemsLeftbar = [
...

    {
      key: '/tracks/upload',
      label: 'Track Upload',
      onClick: () => goTo('/tracks/upload'),
    },

    {
      key: '/releases/create',
      label: 'Release Creation',
      onClick: () => goTo('/releases/create'),
    },
        ...
        >
          {isLeftbar && (
            <Col>
              <Leftbar
                items={itemsLeftbar}
                itemsUser={itemsUser}
                logo={<Image src="https://recognitiongroup.co.za/logo.png" className="m-2" />}
              />
            </Col>
          )}
          ...
          >
            <Topbar
              ...
              logo={!isLeftbar && <Image src="https://recognitiongroup.co.za/logo.png" width={40} height={40} />}
            />
